    ...
    return (
       ...
       {products.map((product, index) => (
            <tr className="text-gray-700 hover:bg-gray-50 dark:hover:bg-gray-100" key={index}>
              ...
              <td className="px-4 py-5 text-xl text-center border">{product.description}</td>
              <td className="px-4 py-5 text-xl text-center border">{product.price}</td>
              <td className="px-4 py-5 text-xl text-center border">{product.quantity}</td>
            </tr>
          ))}
        </tbody>
    )
