...
// 			ville: client.ville,
// 			image: orderItems.map((item) => item.image),
// 			product_id: orderItems.map((item) => item._id),
// 			produits: orderItems.map((item) => item.name),
...
// export default ValiderLaCommande;
