                            ...
                            <h2 className="mb-4 text-xl font-bold">Billing Info</h2>
                                <div className="flex flex-wrap justify-center mb-4">
                                    <div className="w-full mb-6 lg:w-1/2 lg:pl-4 lg:mb-6">
                                        <label htmlFor="billing-name" className="block text-xl font-bold font-medium text-gray-700">
                                            Prenom
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="w-full mb-4 lg:w-1/2 lg:pl-4 lg:mb-6">
                                        <label htmlFor="billing-email-address" className="block text-xl font-bold font-medium text-gray-700">
                                            Email
                                        </label>
                                        <input
                                            type="email"
                                    ...
                                    <div className="w-full mb-4 lg:w-1/2 lg:pl-4 lg:mb-6">
                                        <label htmlFor="billing-phone" className="block text-xl font-bold font-medium text-gray-700">
                                            Téléphone
                                        </label>
                                        <input
                                            type="number"
                                    ...
                                    <div className="w-full mb-4 lg:w-1/2 lg:pl-4 lg:mb-6">
                                        <label htmlFor="billing-city" className="block text-xl font-bold font-medium text-gray-700">
                                            Ville
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="w-full mb-4 lg:w-1/2 lg:pl-4 lg:mb-6">
                                        <label htmlFor="billing-address" className="block text-xl font-bold font-bold font-medium text-gray-700">
                                            Adresse
                                        </label>
                                        <input
                                            type="text"
                                ...
                                <div className="rounded-lg lg:col-span-1">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <table className="w-full p-4 mx-6 table-auto">
                                                <tbody>
                                                    <tr>
                                                        <td colSpan="2">
                                                            <h5 className="m-0 font-size-14 text-lg font-bold">Total articles :</h5>
                                                        </td>
                                                        <td className='text-lg'>{totalPrice}</td>
                                                    </tr>
                                                    <tr>
                                                        <td colSpan="2">
                                                            <h5 className="m-0 font-size-14 text-lg font-bold">Prix livraison :</h5>
                                                        </td>
                                                        <td className='text-lg'>{deliveryCost[deliveryOption]}</td>
                                                    </tr>
                                                    <tr className="bg-light">
                                                        <td colSpan="2">
                                                            <h5 className="m-0 font-size-14 text-lg font-bold">Total :</h5>
                                                        </td>
                                                        <td className='text-lg'>{totalPrice + deliveryCost[deliveryOption]}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            <div className="p-2 my-4 mb-4 text-xl font-bold bg-gray-200">
                                                <p className='flex justify-between text-lg font-bold'>
                                                    Total:
                                                    <span className='text-red-500 text-lg'>{totalPrice + deliveryCost[deliveryOption]}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <ButtonComponent
                                        ...
                                        className={`flex justify-center px-3 py-2 mx-auto my-5 text-sm tracking-widest text-white rounded mt-10 ${items.length === 0 ? 'bg-gray-400 cursor-not-allowed' : 'bg-slate-800 hover:bg-slate-900'}`}
