...
const Choix = ({ titre, texte, texte1, textButton, icon }) => {
  return (
    <div className="py-5 flex flex-col items-center justify-center">
      ...
      <h3 className="text-center text-black font-medium mb-3">{titre}</h3>
      <p className="text-center text-black text-sm ">{texte}</p>
      <p className="text-center text-black text-sm mb-4">{texte1}</p>
      <Link
        to="/boutique"
